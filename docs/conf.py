...
# -*- coding: utf-8 -*-
#
# kalite_gtk documentation build configuration file, created by
...
release = kalite_gtk.__version__
...
htmlhelp_basename = 'kalite_gtkdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'kalite_gtk.tex',
     u'kalite_gtk Documentation',
     u'Foundation for Learning Equality', 'manual'),
]
